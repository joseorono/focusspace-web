...
const SlidersHorizontalIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  ({ size = 24, color = 'currentColor', strokeWidth = 2, className = '' }, ref) => {
    ...
    const stop = useCallback(() => {
      void animate('.slider-1, .slider-2, .slider-3', { x: 0 }, { duration: 0.3 })
      void animate('.path-1-left', { x2: 10 }, { duration: 0.3 })
      void animate('.path-1-right', { x1: 14 }, { duration: 0.3 })
      void animate('.path-2-left', { x2: 8 }, { duration: 0.3 })
      void animate('.path-2-right', { x1: 12 }, { duration: 0.3 })
      void animate('.path-3-left', { x2: 12 }, { duration: 0.3 })
      void animate('.path-3-right', { x1: 16 }, { duration: 0.3 })
    }, [animate])
