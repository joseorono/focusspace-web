export function QuoteSection() {
  return (
    <section className="relative overflow-hidden px-6 py-8 sm:py-6">
      <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
        {/* Decorative quotation mark - Color suavizado */}
        <svg
          className="mb-4 h-14 w-14 animate-fade-up text-white/20"
          viewBox="0 0 32 32"
          fill="currentColor"
          aria-hidden="true"
        >
        ...
        >
          <p className="text-2xl font-serif italic leading-snug text-white md:text-4xl tracking-tight">
            &ldquo;I built this because I needed it. <br /> I&rsquo;m shipping
            it because maybe you do too.&rdquo;
          </p>
        </blockquote>
        <div
          className="mt-6 flex flex-col items-center gap-3 animate-fade-up sm:flex-row sm:text-left"
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <span className="mt-1 text-sm font-medium text-primary-light/90">
