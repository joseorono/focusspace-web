  ...
  return (
    <section className="relative overflow-hidden px-6 py-8 sm:py-6">
      <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
        ...
        <blockquote className="space-y-3 animate-fade-up" style={{ animationDelay: '150ms' }}>
        ...
        <div className="mt-6 flex flex-col items-center gap-3 animate-fade-up sm:flex-row sm:text-left" style={{ animationDelay: '300ms' }}>
